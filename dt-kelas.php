...
if(strval($_SESSION['SES_LOGIN_LEVEL']) === "admin" || strval($_SESSION['SES_LOGIN_LEVEL']) === "operator"):
    ...
    if($mod == "edit") :
		$sql = $conn->query("SELECT * FROM tbl_kelas WHERE id_kelas='".$id."'")->fetch_object();
        ?>
<div class="card">
    <div class="header">
        <i class="material-icons">edit</i>
			...
			<a href="<?= site_url('kelas');?>" class="btn bg-indigo btn-sm pull-right">
        		...
        		<div class="col-lg-12 col-md-12 col-sm-8 col-xs-7">
        			<div class="form-group">
        				<div class="form-line">
        					...
        					<input class="form-control input-lg" type="text" name="kelas" value="<?= $sql->kelas?>" required>
						</div>														
			       </div>
			    </div>
			</div>
                ...
                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-7">
                    <div class="form-group">
                        <div class="pull-right">
                        	<a href="<?= site_url('kelas')?>" class="btn bg-grey btn-lg">
                        		BATAL
                        	</a>
...
<div class="card">
	<div class="body">
		 <table id="data-kelas" class="table table-striped table-hover dataTable" width="100%">
			<thead>
				<tr>
					<th class="hide">ID</th>
					<th>No</th>
								    ...
								    <div class="col-lg-12 col-md-12 col-sm-8 col-xs-7">
								        <div class="form-group">
											<div class="form-line">
											    ...
											    <input class="form-control input-lg" type="text" name="kelas" placeholder="Kelas :" required>
											</div>														
								        </div>
								    </div>
								</div>
