...
//devtaskio is my plan site that meaning developer tasik input output :v 
$accepted_origins = array("http://localhost", "https://devtaskio.net");//dont replace or application will crash
// Images upload dir path
$imgFolder = "./images/img_soal/";
reset($_FILES);
$tmp = current($_FILES);
if(is_uploaded_file($tmp['tmp_name'])){
    ...
    $url = $config['app']['url']."/".str_replace("./","",$filePath);
